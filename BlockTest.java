 ...
 * @author  Anu Datar 
 * Added assertions 
 * Added erroneous assertions with intention of 
 * asking students to fix them as an exercise.
 * @version Feb 1, 2016
 *
...
public class BlockTest
{
     ...
     *
     * Called before every tefst case method.
     */
    @Before
    public void setUp()
    {
     ...
     * Each is preceded by the attribute tag 
     * @Test - if commented out will not appear in list of tests, 
    ...
    public void testingPreamble()
    {
        ...
        System.out.println("Find Test Result window and click ");
    ...
    //Fix the assertion below
        ...
        // note In this block of tests (only), 
        // the assert calls affect the test state 
