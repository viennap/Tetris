...
public class BlockDisplay extends JComponent implements KeyListener
{
    ...
    public void paintComponent(Graphics g)
    {
        ...
        g.setColor(TEXT); 
        g.drawString("Lines Cleared:",5,15); 
        g.drawString(toString(score),100,15); 
    }
     ...
     * Sets score of game. 
     * 
     * @param s     integer that score is being set to
     */
     ...
     * 
     * @param num   number being converted to string
     * 
     * @return      integer that has been converted to string
     */
